...
# ======================
DAISY_ND["himmilbeau"] = Dict("dom" => a×b,
    "numvars" => 2,
    "vars" => "x1 x2",
...
DAISY_ND["kepler1"] = Dict("dom" => a×b×c×d×e×f,
    "numvars" => 6,
...
DAISY_ND["kepler2"] = Dict("dom" => a×b×c×d,
    "numvars" => 4,
    "vars" => "x1 x2 x3 x4",
...
DAISY_ND["kepler3"] = Dict("dom" => a×b×c×d×e×f,
    "numvars" => 6,
    "vars" => "x1 x2 x3 x4 x5 x6",
...
DAISY_ND["Rigidbody1"] = Dict("dom" => a×b×c,
    "numvars" => 3,
    "vars" => "x1 x2 x3",
...
DAISY_ND["Rigidbody2"] = Dict("dom" => a×b×c,
    "numvars" => 3,
    "vars" => "x1 x2 x3",
